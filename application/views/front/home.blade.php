...
<header class="text-center" style="background:url('{{load_asset('')}}')">
			...
			<!-- old navbar-brand -->
				<nav class="navbar navbar-light bg-white justify-content-between">
					<div class="container">
						...
						<form method="GET" action="{{base_url('./dashboard/')}}" target="_blank">
							<button class="btn btn-round btn-danger"></span>BUKA DASHBOARD PENGGUNAAN SIIRMAAYU</button>
						</form>
						<form class="form-inline" method="GET" action="{{base_url('auth/login')}}" target="_blank">
...
<footer class="m-2 text-center">
	<p style="font-size: 14px;">Copyright © 2013-2021 {{$application_copyright}}</p>
</footer>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<p class="text-right mb-0" style="font-size: 14px;">© 2013-2021 {{$application_copyright}}</p>
			</div>
		</div>
	</div>
</div>
