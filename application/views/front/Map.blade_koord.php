...
<script type="text/javascript">
	$(function(){
		...
		var map = new google.maps.Map(document.getElementById('map'), {
			...
			mapTypeId: 'hybrid',
			styles: [{
				"stylers":[{"hue":"#007fff"},{"saturation":59}]},{"featureType":"all","elementType": "all","stylers":[{"visibility": "on"}]},{"featureType":"road","elementType": "geometry.stroke","stylers":[{"gamma": 0.01},{"lightness": 20}]},{"featureType":"poi","elementType":"geometry","stylers":[{"visibility":"on"}]
			}]
		});
