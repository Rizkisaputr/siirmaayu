...
<head>
	...
	<!-- new style -->
	<link rel="stylesheet" href="{{load_asset('new-assets/css/default/style.min.css')}}">
	<!-- <link rel="stylesheet" href="{{load_asset('new-assets/css/default/responsive.min.css')}}"> -->
	<link rel="stylesheet" href="{{load_asset('new-assets/css/apple/style-responsive.min.css')}}">
	<link rel="stylesheet" id="theme" href="{{load_asset('new-assets/css/default/theme/default.css')}}">
	<!-- iCheck -->
...
<script src="{{load_asset('new-assets/js/theme/default.min.js')}}"></script>
