...
<nav class="navbar navbar-light bg-gradient-aqua">
        <div class="text-center text-black"><font size='3'> <b>{{$application_copyright}}    |   {{$application_name}} {{$version}}  |  <i><b small color='#b9ddca'>   {{$covid}} </b></i> |</b> {{$application_long_name}}</a></font></div>                             
</nav>
<!-- end old navbar -->

<header class="text-left" style="background:url('{{load_asset('front/images/bg-header.jpg')}}')">
...
<link rel="stylesheet" href="{{load_asset('sijariemas/css/good.css')}}">
@endsection
        ...
        <div id="form">
            <div class="login-content" align="center"><p class="form-item"><font size='3' color='#000000' ><b>Masukkan e-mail dan password </p></b></font>  
                        ...
                        <div class="form-group m-b-15">
                            {!! form_input($identity,'','class="form-control" placeholder="Email, contoh: rspkm_cibatu@gmail.com"') !!}
                        </div>
                        <div class="form-group m-b-15">
                        ...
                        <div class="login-buttons">
                                ...
                                <button type="button" class="btn btn-warning btn-block btn-md"> <a href="{{base_url('./dashboard')}}" target="_blank" class="f-w-300 text-white"> <b>DASHBOARD PENGGUNAAN SIIRMAAYU </b> </a></button>
                                
                                <button type="button" class="btn btn-danger btn-block btn-md"> <a href="{{base_url('./home')}}" target="_blank" target="_blank" class="f-w-300 text-white"> <b>DASHBOARD BED / RUANGAN </b></a></button> 
                                
                                <button type="button" class="btn btn-info btn-block btn-md"> <a href="{{base_url('./map')}}" target="_blank" target="_blank" class="f-w-300 text-white"> <b>PETA FASKES DAN AMBULAN</b></a></button>
                        </div>
                        <br>
                            <p class="text-center text-grey-darker">
                                &copy; 2013-2021 {{$application_copyright}} <br>{{$application_name}} {{$version}}
                            </p>
                            <hr>
                         {!! form_close() !!}
                        </div>
                	    ...
                	    <div class="col-lg-12">
                    	<div class="clearfix">
                            		<div class="text-center"><a href="https://siirmaayu.id/" target="_blank"> <img class="width-100 text-center" src="{{load_asset('new-assets/img/login-bg/smartrujukan.jpg')}}" alt=""></div>
                                                                        <?php
                                    function IPnya() {
                                        $ipaddress = '';
                                    ...
                                    <div class="wa-image-container"><img class="wa-image" src="{{load_asset('new-assets/img/login-bg/4a376104.svg')}}" alt="whatsapp-smartrujukan"></div>
