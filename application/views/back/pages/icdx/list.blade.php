...
<div id="content" class="content">
	<ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">ICD X</li>
    </ol>
	<h1 class="page-header f-s-14 f-w-500">ICD X</h1>
	<div class="panel panel-inverse">
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/admin/icdx/add')}}" type="" class="btn btn-sm btn-primary">Tambah ICD X</a>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'{{base_url('panel/admin/icdx/list')}}'
				},
				columns:[
					{
						data:'id_icdx',
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"{{base_url('panel/admin/icdx/edit/')}}"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"{{base_url('panel/admin/icdx/delete/')}}"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
