		...
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/admin/jenis/add')}}" type="" class="btn btn-sm btn-primary">Tambah Jenis Faskes</a>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'{{base_url('panel/admin/jenis/list')}}'
				},
				columns:[
					{
						data:'id_enum',
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"{{base_url('panel/admin/jenis/edit/')}}"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"{{base_url('panel/admin/jenis/delete/')}}"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
