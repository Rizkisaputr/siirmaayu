			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						{!! form_input('nama','','class="form-control" id="nama" placeholder="Nama Dokter" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Nomor IDI','no_idi') !!}
						{!! form_input('no_idi','','class="form-control" id="no_idi" placeholder="Nomor IDI Dokter" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Bidang','bidang') !!}
						{!! form_input('bidang','','class="form-control" id="bidang" placeholder="bidang" required') !!}
					</div>
				</div>
