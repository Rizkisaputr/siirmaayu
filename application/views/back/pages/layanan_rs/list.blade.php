...
<div id="content" class="content">
	...
	<h1 class="page-header f-s-14 f-w-500">Layanan</h1>
	<div class="panel panel-inverse">
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/rumah_sakit/layanan/add')}}" type="" class="btn btn-sm btn-primary">Tambah Layanan</a>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'{{base_url('panel/rumah_sakit/layanan/data')}}'
				},
				columns:[
					{
						data:'id_dokter',
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"{{base_url('panel/rumah_sakit/layanan/edit/')}}"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"{{base_url('panel/rumah_sakit/layanan/delete/')}}"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
