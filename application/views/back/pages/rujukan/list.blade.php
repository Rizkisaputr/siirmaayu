			...
			<div class="btn-toolbar">
                ...
                <div class="btn-group ml-auto">
                	<div class="form-group m-r-1">
                        <a href="{{base_url('panel/laporan/rujukan')}}" type="button" class="btn btn-sm btn-primary">Export Rujukan&nbsp;<i class="fa fa-download"></i></a> 
                    </div>
               	</div>
            </div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				serverSide:true,
				ajax:{
					url:'{{base_url('panel/rujukan/rujuk/data')}}'
				},
				columns:[
					{
						data:'type',
