			...
			<div class="panelruj panel-inverse">
				...
				<div class="panel-body">
					<div class="form-group">
						{!! form_label('Nama WUS / Pasien','nama') !!}
						{!! form_input('nama','','class="form-control" id="nama" placeholder="Nama WUS / Pasien" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Nama Pasangan / Penanggung Jwb','pasangan') !!}
						{!! form_input('pasangan','','class="form-control" id="pasangan" placeholder="Nama Suami / Penanggung Jawab" required') !!}
					</div>					
					<div class="form-group">
						{!! form_label('Diagnosa','diagnosa') !!}
						{!! form_input('diagnosa','','class="form-control" id="diagnosa" placeholder="Isilah dengan diagnosa dokter" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Faktor Risiko','risiko') !!}
						{!! form_input('risiko','','class="form-control" id="risiko" placeholder="Isilah dengan Semua Faktor Risiko terdeteksi" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Faskes Pengampu','rs_owner') !!}
						{!! form_dropdown('rs_owner[]',$selection_rs,'','id="rs_owner" class="form-control form-control-sm select2" multiple="multiple" data-placeholder="Pilih Puskesmas atau Rumah Sakit" style="width: 100%;"') !!}
					</div>					
					<div class="form-group">
						{!! form_label('NIK','nik') !!}
						{!! form_input('nik','','class="form-control form-control-sm" id="nik" placeholder="No Identitas"') !!}
					</div>
					<div class="form-group">
						{!! form_label('Nomor Handphone Pasien','kontak') !!}
						{!! form_input('kontak','','class="form-control form-control-sm" id="kontak" placeholder="Nomor Telepon"') !!}
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						{!! form_dropdown('jenis_kelamin',array('Perempuan'=>'Perempuan','Laki-laki'=>'Laki-laki'),'','class="form-control form-control-sm new_group" id="jenis_kelamin" placeholder="Jenis Kelamin"') !!}
					</div>
					<div class="form-group">
						{!! form_label('Alamat','alamat') !!}
						{!! form_textarea('alamat','','class="form-control form-control-sm" rows="2" placeholder="Alamat Pasien..."style="height: 50px;"') !!}
					</div>
					<div class="form-group">
				...
				<footer class="footer-content bg-silver">
				    <div class="pull-left">
				        <div class="dropdown">
				        	{!! anchor(base_url('panel/rujukan/pasien'),'<i class="fas fa-arrow-alt-circle-left"></i> Back','class="btn btn-sm btn-warning"') !!}
				        </div>
				    </div>
