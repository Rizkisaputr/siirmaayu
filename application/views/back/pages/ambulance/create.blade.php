			...
			<div class="panel -panel-inverse">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						{!! form_dropdown('merk',$selection_merk,null,'class="form-control form-control-sm" id="merk"') !!}
					</div>
					<div class="row">
						<div class="col-xs-4">
							<div class="bootstrap-timepicker">
								<div class="form-group">
									...
									{!! form_input('tahun_produksi','','class="form-control form-control-sm" id="tahun"') !!}
								</div>
							</div>
						</div>
						<div class="col-xs-4">
							<div class="bootstrap-timepicker">
								<div class="form-group">
									...
									{!! form_input('nopol','','class="form-control form-control-sm" id="nopol"') !!}
								</div>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						{!! form_dropdown('fungsi',$selection_fungsi,null,'class="form-control form-control-sm" id="fungsi"') !!}
					</div>
					<div class="form-group">
						{!! form_label('API','api') !!}
						{!! form_textarea('api',null,'class="form-control form-control-sm" id="api" style="height: 60px"') !!}
					</div>
					<div class="form-group">
