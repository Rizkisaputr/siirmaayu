			...
			<div class="panel -panel-inverse">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						{!! form_dropdown('gol_darah',$selection_gol_darah,null,'class="form-control form-control-sm" id="gol_darah"') !!}
					</div>
					<div class="form-group">
						{!! form_label('Stok','stok') !!}
						{!! form_input('stok','','class="form-control form-control-sm" id="stok"') !!}
					</div>
					<div class="form-group">
						{!! form_label('Keterangan','keterangan') !!}
						{!! form_textarea('keterangan','','class="form-control form-control-sm" id="keterangan" style="height: 60px"') !!}
