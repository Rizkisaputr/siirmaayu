		...
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/rumah_sakit/faskes/add')}}" type="" class="btn btn-sm btn-primary">Tambah Alat Kesehatan</a>
				</div>
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/rumah_sakit/faskes/template')}}" type="" class="btn btn-sm btn-success">Template Excel</a>
				</div>
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/rumah_sakit/faskes/import')}}" type="" class="btn btn-sm btn-info">Import Excel</a>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'{{base_url('panel/rumah_sakit/faskes/data')}}'
				},
				columns:[
					{
						data:'id_faskes',
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"{{base_url('panel/rumah_sakit/faskes/edit/')}}"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"{{base_url('panel/rumah_sakit/faskes/delete/')}}"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
