			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						{!! form_input('nama_faskes',$edit_data['nama_faskes'],'class="form-control form-control-sm" id="nama_faskes" placeholder="Nama Alat Kesehatan" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Jumlah Alat Kesehatan','jumlah') !!}
						{!! form_input('jumlah',$edit_data['jumlah'],'class="form-control form-control-sm" id="jumlah" placeholder="Jumlah ketersediaan Alat Kesehatan" required') !!}
					</div>
					<div class="form-group">
