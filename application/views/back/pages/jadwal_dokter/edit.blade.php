			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						{!! form_dropdown('id_dokter',$selection_dokter,$edit_data['id_dokter'],'class="form-control form-control-sm" id="id_dokter" required') !!}
					</div>
					<div class="form-group">
						{!! form_label('Hari','hari') !!}
						{!! form_dropdown('hari',$selection_hari,$edit_data['hari'],'class="form-control form-control-sm" id="hari"') !!}
					</div>
					<div class="row">
						<div class="col-xs-4">
							<div class="bootstrap-timepicker">
								<div class="form-group">
									...
									{!! form_input('jam_mulai',$edit_data['jam_mulai'],'class="form-control form-control-sm timepicker" id="jam_mulai"') !!}
								</div>
							</div>
						</div>
						<div class="col-xs-4">
							<div class="bootstrap-timepicker">
								<div class="form-group">
									...
									{!! form_input('jam_selesai',$edit_data['jam_selesai'],'class="form-control form-control-sm timepicker" id="jam_selesai"') !!}
								</div>
							</div>
						</div>
					</div>
