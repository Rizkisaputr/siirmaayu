...
<div id="content" class="content">
	...
	<h1 class="page-header f-s-14 f-w-600">{{ $title }}</h1>
	<div class="panel panel-inverse">
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
                <div class="dropdown m-r-2">
                    <a href="{{base_url('panel/rujukan/psc/add')}}" class="btn btn-sm btn-success">
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				serverSide:true,
				ajax:{
					url:'{{base_url('panel/rujukan/psc/data')}}'
				},
				columns:[
					{data:'nama_rs',},
					{data:'nama_pelapor'},
					...
					{data:'kategori_psc'},
					{
						...
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"{{base_url('panel/rujukan/psc/edit/')}}"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"{{base_url('panel/rujukan/psc/delete/')}}"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
