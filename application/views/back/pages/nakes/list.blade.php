		...
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
				<div class="dropdown m-r-2">
					<a href="{{base_url('panel/rumah_sakit/nakes/add')}}" type="" class="btn btn-sm btn-primary">Tambah Nakes</a>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'{{base_url('panel/rumah_sakit/nakes/data')}}'
				},
				columns:[
					{
						data:'id_nakes',
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"{{base_url('panel/rumah_sakit/nakes/edit/')}}"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"{{base_url('panel/rumah_sakit/nakes/delete/')}}"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
