			...
			<div class="panelruj panel-inverse">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<?php echo form_input('nama','','class="form-control form-control-sm" id="nama" placeholder="Nama Fasilitas Kesehatan" required'); ?>

					</div>
					<div class="form-group">
						<?php echo form_label('Kode','kode_rs'); ?>

						<?php echo form_input('kode_rs','','class="form-control form-control-sm" id="kode_rs" placeholder="Kode Fasilitas Kesehatan"'); ?>

					</div>
					<div class="form-group">
						<?php echo form_label('Telepon','telepon'); ?>

						<?php echo form_input('telepon','','class="form-control form-control-sm" id="telepon" placeholder="Nomor Telepon Fasilitas Kesehatan" required'); ?>

					</div>
					<div class="form-group">
						<?php echo form_label('Jenis','jenis'); ?>

						<?php echo form_dropdown('jenis',$jenis_rs,'Rumah Sakit','class="form-control form-control-sm" id="jenis" placeholder="Jenis Fasilitas Kesehatan" required'); ?>

					</div>
					<div class="form-group">
						<?php echo form_label('Layanan','layanan'); ?>

						<?php echo form_dropdown('layanan[]',$selection_fasilitas,'','id="layanan" class="form-control form-control-sm select2" multiple="multiple" data-placeholder="Pilih Layanan yang tersedia" style="width: 100%;"'); ?>

					</div>
					<div class="form-group">
						<?php echo form_label('Alamat','alamat'); ?>

						<?php echo form_textarea('alamat','','class="form-control form-control-sm" rows="3" placeholder="Alamat Fasilitas Kesehatan..." style="height: 65px;"'); ?>
