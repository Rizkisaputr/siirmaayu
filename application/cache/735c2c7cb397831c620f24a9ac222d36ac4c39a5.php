		...
		<div class="wrapper bg-silver-lighter">
			<div class="btn-toolbar">
				<div class="dropdown m-r-2">
					<a href="<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/add')); ?>" type="" class="btn btn-sm btn-primary">Tambah Jadwal Dokter</a>
				</div>
				<div class="dropdown m-r-2">
					<a href="<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/template')); ?>" type="" class="btn btn-sm btn-success">Template Excel</a>
				</div>
				<div class="dropdown m-r-2">
					<a href="<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/import')); ?>" type="" class="btn btn-sm btn-info">Import Excel</a>
				</div>
				<!--<div class="dropdown m-r-2">
					<a href="<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/data')); ?>" type="" class="btn btn-sm btn-success">Template Excel</a>
				</div>
				<div class="dropdown m-r-2">
					<a href="<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/data')); ?>" type="" class="btn btn-sm btn-info">Import Excel</a>
				</div>-->
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			$('#main-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/data')); ?>'
				},
				columns:[
					{
						...
						render:function(data, type, row, meta){
							return "<div class=\"btn-group\">\n" +
									...
									"<li><a href=\"<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/edit/')); ?>"+data+"\">Edit</a></li>\n" +
									"<li><a class='konfirmasi-hapus' href=\"<?php echo e(base_url('panel/rumah_sakit/jadwal_dokter/delete/')); ?>"+data+"\">Delete</a></li>\n" +
									"</ul>\n" +
									"</div>";
						}
					},
