	                                ...
	                                <div class="row">
	                                    <div class="col-lg-6">
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-md-10">
	                                               <?php echo form_input('nama','','class="form-control form-control-sm new_group" id="kontak" required placeholder="Nama Pasien"'); ?>
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-md-10">
	                                                <?php echo form_input('kontak','','class="form-control form-control-sm new_group" id="kontak" required placeholder="Kontak Pasien"'); ?>
	                                        ...
	                                        <div class="form-group row">
	                                            <label class="col-form-label col-md-2">Umur</label>
	                                              <div class="col-md-10">
	                                               <?php echo form_input('ibuanak_umur','','class="form-control form-control-sm new_group" id="kontak" required placeholder="Umur"'); ?>
	                                    ...
	                                    <div class="col-lg-6">
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-md-10">
	                                                <?php echo form_textarea('diagnosis','','class="form-control" required style="height: 80px" placeholder="Jika COVID, tambah info status COVID & COMORBID, misal: PDP COVID, Confirmed + COVID & DM. PILIH KELAS BED: ISOLASI COVID, LAYANAN RS: ISOLASI COVID "'); ?>
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-md-10">
	                                                <?php echo form_dropdown('transportasi',$transportasi_select,'','class="form-control default-select2" required style="width: 40%'); ?>
	                                ...
	                                <div class="row">
	                                    <div class="col-lg-6">
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-md-10">
	                                               <?php echo form_input('ibuanak_namasuami','','class="form-control form-control-sm new_group" id="kontak" required placeholder="Nama Suami"'); ?>
	                                    ...
	                                    <div class="col-lg-6">
	                                        ...
	                                        <div class="form-group row m-b-15">
	                                            <label class="col-form-label col-md-2">Tindakan Pra Rujukan</label>
	                                            <div class="col-md-10">
	                                                <?php echo form_input('tindakan','','class="form-control form-control-sm" id="tindakan" required placeholder="Tata Laksana Pra Rujukan/Stabilisasi"'); ?>
