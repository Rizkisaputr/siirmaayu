	...
	<div class="row">
        <!-- <div class="col-lg-3 col-md-6">
            <div class="widget widget-stats bg-white text-inverse">
                <div class="stats-content">
                    ...
                    <div class="stats-number"><?php echo e($my_rujukan_count); ?></div>
        ...
        <div class="col-lg-3 col-md-6">
			<div class="widget widget-stats bg-gradient-blue">
				...
				<div class="stats-info">
					<h4>TOTAL RUJUKAN</h4>
					<p><?php echo e($my_rujukan_count); ?></p>	
				</div>
        ...
        <div class="col-lg-3 col-md-6">
			<div class="widget widget-stats bg-gradient-green">
				...
				<div class="stats-link">
					<a href="javascript:;">Rujukan yang Telah Diterima <i class="fa fa-arrow-alt-circle-left"></i></a>
				</div>
			</div>
		</div>
        <!-- <div class="col-lg-3 col-md-6">
        ...
        <div class="col-lg-3 col-md-6">
			<div class="widget widget-stats bg-gradient-red">
				...
				<div class="stats-link">
					<a href="javascript:;">Rujukan yang Dikembalikan <i class="fa fa-arrow-alt-circle-down"></i></a>
				</div>
			</div>
		</div>
        <!-- <div class="col-lg-3 col-md-6">
        ...
        <div class="col-lg-3 col-md-6">
			<div class="widget widget-stats bg-gradient-orange">
				...
				<div class="stats-link">
					<a href="javascript:;">Rujukan yang Belum Direspon <i class="fa fa-arrow-alt-circle-up"></i></a>
				</div>
			</div>
		</div>
    </div>
...
<?php $__env->startSection('script'); ?>
	...
	<script src="<?php echo e(load_asset('bower_components/Flot/jquery.flot.js')); ?>"></script>
	<!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
	<script src="<?php echo e(load_asset('bower_components/Flot/jquery.flot.resize.js')); ?>"></script>
	<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
	<script src="<?php echo e(load_asset('bower_components/Flot/jquery.flot.pie.js')); ?>"></script>
	<!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
	<script src="<?php echo e(load_asset('bower_components/Flot/jquery.flot.categories.js')); ?>"></script>
	<audio id="sirine" loop="loop">
		<source src="<?php echo e(load_asset('etc/sirine.mp3')); ?>" type="audio/mp3"/>
	</audio>
	<script type="text/javascript">
		...
		$(function(){
			...
			function refresh_rujuk_balik() {
				...
				$.get("<?php echo base_url('panel/dashboard_data_rujukan'.$param_pie); ?>",function(res){
				...
				setTimeout(refresh_rujuk_balik,6000);
			}
			...
			$('#bed-table').DataTable({
				...
				autoWidth :false,
				ajax:{
					url:'<?php echo base_url('panel/dashboard_data_bed/'.$param_bed); ?>'
				},
				order:[[7,'desc']],
				columns:[
					{data:'nama_rs'},
			...
			var table=$('#rujukan-table').DataTable({
				...
				order:[[11,'DESC']],
				ajax:{
					url:'<?php echo base_url('panel/rujukan/'.($is_puskesmas?'rujuk/data':'balik/data_param').'/'.$param_rujuk); ?>'
				},
				columns:[
					{
						data:'type',
					...
					render:function(data, type, row, meta){
							if (row.status_rujukan == 'Diterima') {
								if (row.rujukbalik_status == 'Pulang') {
									...
									return "<a class='btn btn-purple btn-sm' href=\"<?php echo e(base_url('panel/rujukan/balik/jawab/')); ?>"+data+"\">Rujuk Balik <br> / Batal</a>";
								} 
								...
								return "<a class='btn btn-danger btn-sm' href=\"<?php echo e(base_url('panel/rujukan/balik/action/')); ?>"+data+"\"><b>Jawab</b></a>";
							}
        ...
        //function ini untukSMS. SMS bisa masuk
    	function refresh_sms1() 
    	{
    		setInterval(function() {
    			$.ajax({
    				type: "GET",
    				url:'<?php echo e(site_url('home/api_sms1')); ?>',
    				dataType: "json",
    				success: function(res) {
    					$.ajax({
    	                    url: '<?php echo e(base_url('home/process_sms1')); ?>',
    	                    type: "POST",
    	                    data: res,
    	                    cache: false,
    	                    dataType: "json",
      ...
      //Start function WA, ini untuk WA ini tida masalah. SMS bisa masuk
