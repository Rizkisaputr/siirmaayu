...
<head>
	...
	<!-- Theme style -->
	<link rel="stylesheet" href="<?php echo e(load_asset('new-assets/css/apple/style.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(load_asset('new-assets/css/apple/custom.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(load_asset('new-assets/css/apple/style-responsive.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(load_asset('new-assets/css/apple/theme/default.css')); ?>">
	<!-- Pace style -->
	<link rel="stylesheet" href="<?php echo e(load_asset('new-assets/plugins/pace/pace.min.js')); ?>">
	<!-- Toaster -->
	<link rel="stylesheet" href="<?php echo e(load_asset('bower_components/toastr/toastr.min.css')); ?>">
...
<!-- <script src="<?php echo e(load_asset('bower_components/jquery/dist/jquery.min.js')); ?>"></script> -->
<!-- Bootstrap 3.3.7 -->
...
<script src="<?php echo e(load_asset('new-assets/plugins/pace/pace.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(load_asset('bower_components/fastclick/lib/fastclick.js')); ?>"></script>
<!--Toaster-->

<script src="<?php echo e(load_asset('bower_components/toastr/toastr.min.js')); ?>"></script>

<!-- AdminLTE App -->

<script src="<?php echo e(load_asset('new-assets/js/theme/apple.min.js')); ?>"></script>
<script src="<?php echo e(load_asset('new-assets/js/apps.min.js')); ?>"></script>
<!-- <script src="<?php echo e(load_asset('new-assets/js/apps.min.js')); ?>"></script> -->
<script src="<?php echo e(load_asset('new-assets/js/demo/form-plugins.demo.min.js')); ?>"></script>
<!-- <script src="<?php echo e(load_asset('dist/js/bayu.js')); ?>"></script> -->
